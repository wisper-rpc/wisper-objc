 ...
 */
@interface WSRPCPropertyBinding : NSObject
...
/**
 ...
 Uses KVO.
 */
@interface WSRPCPropertyBinder : NSObject
...
/**
 ...
 @return A binding object that can be used to remove the binding.
 */
-(WSRPCPropertyBinding *)addBindingForTarget:(NSObject *)target atKeyPath:(NSString *)keyPath transformSetValueBlock:(id (^)(id newValue)) transformSetValueBlock;
